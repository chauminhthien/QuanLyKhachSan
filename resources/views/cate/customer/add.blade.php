      ...
      <form role="form" action="" method="post">
          <div class="box-body">
            <div class="form-group col-md-12">
              ...
              <input type="text" name="name" required class="form-control" id="name" placeholder="Nhập Tên khách hàng">
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" name="cmnd" required class="form-control" id="cmnd" placeholder="Nhập Chứng Minh Nhân Dân">
              </div>
            <div class="form-group col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" id="datemask" name="ngaysinh" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask />
              </div>
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" name="diachi" class="form-control" id="diachi" placeholder="Nhập Địa Chỉ Nhà">
            </div>
            <div class="form-group col-md-6">
