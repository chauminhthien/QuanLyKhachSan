      ...
      <form role="form" action="" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" name="name" required value="{{$hangphong->name}}" class="form-control" id="name" placeholder="Nhập Tên Hạng Phòng">
            </div>
            <div class="form-group">
              <label for="gia">Giá</label>
              <input type="number" name="gia" required min="1" value="{{$hangphong->gia}}" class="form-control" id="gia" placeholder="Nhập Giá Hạng Phòng">
            </div>
          </div><!-- /.box-body -->
