      ...
      <form role="form" action="" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" name="name" value="{{$lau->name}}" required class="form-control" id="name" placeholder="Nhập Tên  Lầu">
            </div>
            <div class="form-group">
              <label for="vitri">Vị trí Lầu</label>
              <input type="text" name="vitri" value="{{$lau->vitri}}" class="form-control" id="vitri" placeholder="Nhập vị trí Lầu">
            </div>
            <div class="form-group">
              <label for="mota">Mô Tả</label>
              <textarea name="mota" class="form-control" id="mota">{{$lau->mota}}</textarea>
            </div>
          </div><!-- /.box-body -->
